...
기능 단위로 순차 진행. 각 단계별 코드 리뷰 + 버그 수정.

| # | 영역 | 상태 |
|---|------|------|
| 1 | 인증 / 온보딩 | ✅ 완료 |
| 2 | 결제 흐름 (청구서 → PortOne → Toss) | ✅ 완료 |
| 3 | 입주민 관리 (등록·전출·정산) | ✅ 완료 |
| 4 | 공지 / 투표 | ✅ 완료 |
| 5 | 차량 / 티켓 / 점검 (F-94·F-95·F-96·F-99) | ✅ 완료 |
| 6 | 크론 잡 (일일 스케줄러 로직 검증) | ✅ 완료 |
| 7 | 백오피스 (SUPER_ADMIN 플로우) | ✅ 완료 |
