...
let Building = (() => {
    ...
    var Building = class {
        ...
        static {
            ...
            _units_decorators = [(0, typeorm_1.OneToMany)(() => unit_entity_1.Unit, (unit) => unit.building)];
        ...
        units = (__runInitializers(this, _address_extraInitializers), __runInitializers(this, _units_initializers, void 0));
        constructor() {
