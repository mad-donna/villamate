...
app.post('/api/villas/join', async (req, res) => {
...
app.post('/api/villas/:villaId/invoices', async (req, res) => {
...
app.get('/api/villas/:villaId/invoices', async (req, res) => {
    const villaId = parseInt(String(req.params.villaId), 10);
    if (isNaN(villaId))
        return res.status(400).json({ error: 'Invalid villaId' });
    try {
...
app.get('/api/residents/:residentId/payments', async (req, res) => {
...
app.post('/api/villas/:villaId/auto-billing', async (req, res) => {
    const villaId = parseInt(String(req.params.villaId), 10);
    if (isNaN(villaId))
        return res.status(400).json({ error: 'Invalid villaId' });
...
app.get('/api/users/:userId/villa', async (req, res) => {
...
app.get('/api/villas/:adminId', async (req, res) => {
